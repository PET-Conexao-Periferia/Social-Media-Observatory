...
def salvar_post_json(post):
    ...
    try:
        ...
        if legenda:
            ...
            m = re.search(
                r"([\d\.,]+\s*(?:mil|mi|k|m)?)\s*likes?[,;:\s]+([\d\.,]+\s*(?:mil|mi|k|m)?)\s*comments?",
                legenda,
                re.I
            )
            ...
            if m:
                ...
                # Só usa a legenda se o scraper não tiver fornecido likes.
                if likes is None:
                ...
                if m2:
                    ...
                    # Só usa a legenda se o scraper não tiver fornecido likes.
                    if likes is None:
                        likes = _parse_metrica(m2.group(1))
